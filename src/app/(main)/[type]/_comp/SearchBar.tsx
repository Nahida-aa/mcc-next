...
export const SearchBar = ({ type, keyword = "", onSearch, onTypeChange }: SearchBarProps) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center  gap-3 bg-[#8B4513] rounded-md h-12 min-h-12 mt-2 px-2">
      ...
      <div className="flex items-center justify-end gap-1 min-w-fit">
        {/* 前6个类型 */}
        <ToggleGroup className="flex-wrap gap-1" type="single" value={type || "mod"} onValueChange={onTypeChange}>
